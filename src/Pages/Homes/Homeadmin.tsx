        ...
        <div className="col-md-12 grid-margin">
          <div className="row">
            <div className="col-12 col-xl-8 mb-4 mb-xl-0">
              <h3 className="font-weight-bold">Administrator</h3>
              <h6 className="font-weight-normal mb-0"> ส่วนจัดการผู้ดูแลระบบงานเจ้าหน้าที่ <span className="text-primary">รพ.สกลนคร</span></h6>
            </div>
